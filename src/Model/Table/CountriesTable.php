...
class CountriesTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->integer('gold_medal_count')
            ->requirePresence('gold_medal_count', 'create')
            ->notEmptyString('gold_medal_count');

        $validator
            ->integer('silver_medal_count')
            ->requirePresence('silver_medal_count', 'create')
            ->notEmptyString('silver_medal_count');

        $validator
            ->integer('bronze_medal_count')
            ->requirePresence('bronze_medal_count', 'create')
            ->notEmptyString('bronze_medal_count');
